...
const stadiums = [  {'Name': "Mario Stadium", 'foulX': -57, 'startingX': [-57, -44, -14, 16],'endingX': [-44, -14, 16, 57], 'wallHeight': [3, 3, 3, 3], 'm': [1.65, 0.69, 0, -1.05], 'c': [151.3, 110.7, 100, 116.8]},
                    ...
                    {'Name': "Wario Palace", 'foulX': -51, 'startingX': [-51, -49, -39, -26, -9, 9, 26, 39, 49], 'endingX': [-49, -39, -26, -9, 9, 26, 39, 49, 51], 'wallHeight': [5, 5, 5, 5, 5, 5, 5, 5, 5], 'm': [6.25, 1.55, .923, .412, 0, -.412, -.923, -1.55, -6.25], 'c': [369.75, 139.75, 115, 101.712, 98, 101.712, 115, 139.75, 369.75]}];
