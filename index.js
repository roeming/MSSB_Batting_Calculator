    ...
    document.getElementById("randomHR").onclick = async function(ev){
        ...
        while (character < 54) {
            ...
            if (BatterHitbox[character].TrimmedBat == 0) {
                ...
                readValues.ballContact_X_Upper = .15;
    
            } else {
                readValues.ballContact_X_Lower = -.35;
            ...
            randHrPercent[character] = [stats[character].Name, average(homeRunInd[ChosenStadium], homeRunInd[ChosenStadium].length)];
    ...
    CalculatedPoints[j].forEach(element => {
        if (hitNoteBlockInd[j] != 0) {
            ...
            while (blockNum < noteBlocks.length) {
                ...
                if(blockBallDist < 2) {
                    hitNoteBlockInd[j] = 1;
                    if (noteBlocks[blockNum].Type == "Random") {hitNoteBlockInd[j] = hitNoteBlockInd[j]*0.5}
                    break;
                }
                blockNum += 1;
            }
